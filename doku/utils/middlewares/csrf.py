...
class CSRFMiddleware:
    DEFAULT_PROTECTED_METHODS: List[str] = [
    ...
    def init_app(self, app):
        ...
        self._signer = Signer(
            self._app.secret_key, salt='csrf_salty_key',
    ...
    def _get_config(app_config) -> dict:
        ...
        _config = {
            ...
            'PROTECTED_METHODS': app_config.get(
                'CSRF_PROTECTED_METHODS',
                CSRFMiddleware.DEFAULT_PROTECTED_METHODS
            ),
            'TOKEN_LENGTH': app_config.get(
